...
| J | contributing states |`zeros(1,16)`, except for `(1,2)=1`| What is this? From Jakob: it's 16 because you have 4 hidden states and 4 sources. It's how these hidden states contribute to the signal? I don't know how, mathematically, though.
